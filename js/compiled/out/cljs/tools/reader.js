...
var G__24754 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24754;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24755 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24755,ch);
...
if(("\\" === ch__$1)){
var ch_24756__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24756__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24756__$2);
} else {
}

var G__24757 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24757;
continue;
}
}
...
var vec__24765 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24765,(0),null);
var start_column = cljs.core.nth.call(null,vec__24765,(1),null);
...
var G__24768 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24768;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24769 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24770 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24770);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24769);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24771 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24771,(0),null);
var start_column = cljs.core.nth.call(null,vec__24771,(1),null);
...
var vec__24774 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24774,(0),null);
var end_column = cljs.core.nth.call(null,vec__24774,(1),null);
...
var vec__24777 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24777,(0),null);
var start_column = cljs.core.nth.call(null,vec__24777,(1),null);
...
var vec__24780 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24780,(0),null);
var end_column = cljs.core.nth.call(null,vec__24780,(1),null);
...
var vec__24783 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24783,(0),null);
var start_column = cljs.core.nth.call(null,vec__24783,(1),null);
...
var vec__24786 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24786,(0),null);
var end_column = cljs.core.nth.call(null,vec__24786,(1),null);
...
var sb = (function (){var G__24789 = (new goog.string.StringBuffer());
G__24789.append(initch);
...
var G__24791 = (function (){var G__24790 = sb;
G__24790.append(ch);

return G__24790;
})();
var G__24792 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24791;
ch = G__24792;
continue;
}
...
switch (G__24795) {
case "\\":
var G__24799 = (function (){var G__24796 = sb;
G__24796.append(cljs.tools.reader.escape_char.call(null,sb,reader));
...
break;
default:
var G__24801 = (function (){var G__24797 = sb;
G__24797.append(ch);

return G__24797;
})();
var G__24802 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24801;
ch = G__24802;
continue;
...
var vec__24803 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24803,(0),null);
var end_column = cljs.core.nth.call(null,vec__24803,(1),null);
...
var vec__24806 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24806,(0),null);
var column = cljs.core.nth.call(null,vec__24806,(1),null);
...
var vec__24811 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24811,(0),null);
var column = cljs.core.nth.call(null,vec__24811,(1),null);
...
var vec__24816 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24816,(0),null);
var column = cljs.core.nth.call(null,vec__24816,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24821 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24821,(0),null);
var start_column = cljs.core.nth.call(null,vec__24821,(1),null);
...
var vec__24824 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24824,(0),null);
var end_column = cljs.core.nth.call(null,vec__24824,(1),null);
...
var G__24827 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24827,true,null,opts,pending_forms);
...
var G__24828 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24828)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24828)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24828)){
...
var _STAR_suppress_read_STAR__orig_val__24829 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24830 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24830);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24829);
}});
...
var G__24831 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24831,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24831,rdr,first_line);
...
var G__24835 = matched;
var G__24836 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24835;
finished = G__24836;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24837 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24838 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24838);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24837);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24839 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24840 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__24840);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24841 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24841,"(");
...
var G__24842 = (i + (1));
var G__24843 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__24839);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24844 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24844);
...
var G__24845 = cljs.core.next.call(null,s__$1);
var G__24846 = ret;
s__$1 = G__24845;
r = G__24846;
continue;
...
var G__24847 = cljs.core.next.call(null,s);
var G__24848 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24847;
key_vals = G__24848;
continue;
} else {
...
var gensym_env_orig_val__24853 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24854 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__24854);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__24853);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24855 = token;
var G__24855__$1 = (((G__24855 == null))?null:cljs.core.subs.call(null,G__24855,(1)));
var G__24855__$2 = (((G__24855__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24855__$1));
var G__24855__$3 = (((G__24855__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24855__$2));
var G__24855__$4 = (((G__24855__$3 == null))?null:cljs.core.symbol.call(null,G__24855__$3));
if((G__24855__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24855__$4);
}
})():(function (){var G__24856 = token;
var G__24856__$1 = (((G__24856 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24856));
if((G__24856__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24856__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24867,reader){
...
var opts = map__24868__$1;
var eof = cljs.core.get.call(null,map__24868__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1688157137466
