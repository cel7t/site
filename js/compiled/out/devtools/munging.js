...
var o28078 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28078["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28079 = temp__5718__auto____$1;
return (o28079["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27436__auto__ = f;
return (o__27436__auto__["toString"]).call(o__27436__auto__);
} else {
return "";
}
}catch (e28080){var _ = e28080;
return "";
}});
...
try{var o__27436__auto___28082 = t;
(o__27436__auto___28082["cljs$lang$ctorPrWriter"]).call(o__27436__auto___28082,t,writer);
}catch (e28081){var __28083 = e28081;
}
...
var char_code = (function (){var o__27436__auto__ = (new String(char$));
return (o__27436__auto__["charCodeAt"]).call(o__27436__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27436__auto__ = String;
return (o__27436__auto__["fromCharCode"]).call(o__27436__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28084 = num_code;
switch (G__28084) {
case (1):
return (185);
...
var o__27436__auto__ = String;
return (o__27436__auto__["fromCharCode"]).call(o__27436__auto__,superscript_code);
});
/**
...
}catch (e28086){var _e__27443__auto__ = e28086;
return false;
}})())){
...
var vec__28087 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28087,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o28090 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28090["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28091 = temp__5718__auto____$1;
return (o28091["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28094){
var vec__28095 = p__28094;
var ns_detector = cljs.core.nth.call(null,vec__28095,(0),null);
...
var G__28101 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28102 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28101;
remaining_tokens = G__28102;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28092){
var G__28093 = cljs.core.first.call(null,seq28092);
var seq28092__$1 = cljs.core.next.call(null,seq28092);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28093,seq28092__$1);
}));
...
var vec__28106 = cljs.core.split_with.call(null,(function (p1__28105_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28105_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28106,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28106,(1),null);
...
var vec__28112 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28112,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28112,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28115 = cljs.core.rest.call(null,remaining_tokens);
var G__28116 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28115;
name_tokens = G__28116;
continue;
} else {
...
var vec__28119 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28119,(0),null);
var arity = cljs.core.nth.call(null,vec__28119,(1),null);
var vec__28122 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28122,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28122,(1),null);
var vec__28125 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28125,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28125,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28125,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28125,(3),null);
...
var vec__28131 = result;
var munged_ns = cljs.core.nth.call(null,vec__28131,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28131,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28131,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28131,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28131,(4),null);
var arity = cljs.core.nth.call(null,vec__28131,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__28135 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__28135,(0),null);
var args = cljs.core.nth.call(null,vec__28135,(1),null);
var vec__28138 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28138,(0),null);
var name = cljs.core.nth.call(null,vec__28138,(1),null);
...
var G__28141 = (arity + (1));
var G__28142 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28143){
var vec__28144 = p__28143;
var arity = cljs.core.nth.call(null,vec__28144,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28144,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__28147_SHARP_){
return cljs.core.get.call(null,arities,p1__28147_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__28148_SHARP_){
return cljs.core.drop.call(null,(2),p1__28148_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28151){
var vec__28152 = p__28151;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28152,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28149){
var G__28150 = cljs.core.first.call(null,seq28149);
var seq28149__$1 = cljs.core.next.call(null,seq28149);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28150,seq28149__$1);
}));
...
var map__28160 = options;
var map__28160__$1 = (((((!((map__28160 == null))))?(((((map__28160.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28160.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28160):map__28160);
var include_ns_QMARK_ = cljs.core.get.call(null,map__28160__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28160__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28160__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28160__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28161 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28161,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28161,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28161,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28161,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28161,(4),null);
var arity = cljs.core.nth.call(null,vec__28161,(5),null);
...
var o__27436__auto__ = f;
return (o__27436__auto__["getBasis"]).call(o__27436__auto__);
});
/**
...
}catch (e28165){var _e__27443__auto__ = e28165;
...
var G__28166 = (obj[cljs.core.first.call(null,path)]);
var G__28167 = cljs.core.rest.call(null,path);
obj = G__28166;
path = G__28167;
continue;
} else {
...
var _STAR_ = (function (accum,p__28168){
var vec__28169 = p__28168;
var bit = cljs.core.nth.call(null,vec__28169,(0),null);
var protocol = cljs.core.nth.call(null,vec__28169,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28172){
var vec__28173 = p__28172;
var ns = cljs.core.nth.call(null,vec__28173,(0),null);
var name = cljs.core.nth.call(null,vec__28173,(1),null);
var selector = cljs.core.nth.call(null,vec__28173,(2),null);
...
var post_process = (function (p__28177){
var vec__28178 = p__28177;
var munged_name = cljs.core.nth.call(null,vec__28178,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28178,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__28176_SHARP_){
return (obj[cljs.core.first.call(null,p1__28176_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1683240954574
