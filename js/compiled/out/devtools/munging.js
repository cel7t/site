...
var o22551 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22551["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22552 = temp__5718__auto____$1;
return (o22552["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21909__auto__ = f;
return (o__21909__auto__["toString"]).call(o__21909__auto__);
} else {
return "";
}
}catch (e22553){var _ = e22553;
return "";
}});
...
try{var o__21909__auto___22555 = t;
(o__21909__auto___22555["cljs$lang$ctorPrWriter"]).call(o__21909__auto___22555,t,writer);
}catch (e22554){var __22556 = e22554;
}
...
var char_code = (function (){var o__21909__auto__ = (new String(char$));
return (o__21909__auto__["charCodeAt"]).call(o__21909__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21909__auto__ = String;
return (o__21909__auto__["fromCharCode"]).call(o__21909__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22557 = num_code;
switch (G__22557) {
case (1):
return (185);
...
var o__21909__auto__ = String;
return (o__21909__auto__["fromCharCode"]).call(o__21909__auto__,superscript_code);
});
/**
...
}catch (e22559){var _e__21916__auto__ = e22559;
return false;
}})())){
...
var vec__22560 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22560,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22563 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22563["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22564 = temp__5718__auto____$1;
return (o22564["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___22571 = arguments.length;
var i__4737__auto___22572 = (0);
while(true){
if((i__4737__auto___22572 < len__4736__auto___22571)){
args__4742__auto__.push((arguments[i__4737__auto___22572]));

var G__22573 = (i__4737__auto___22572 + (1));
i__4737__auto___22572 = G__22573;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22567){
var vec__22568 = p__22567;
var ns_detector = cljs.core.nth.call(null,vec__22568,(0),null);
...
var G__22574 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22575 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22574;
remaining_tokens = G__22575;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22565){
var G__22566 = cljs.core.first.call(null,seq22565);
var seq22565__$1 = cljs.core.next.call(null,seq22565);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22566,seq22565__$1);
}));
...
var vec__22579 = cljs.core.split_with.call(null,(function (p1__22578_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22578_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22579,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22579,(1),null);
...
var vec__22585 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22585,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22585,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22588 = cljs.core.rest.call(null,remaining_tokens);
var G__22589 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22588;
name_tokens = G__22589;
continue;
} else {
...
var vec__22592 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22592,(0),null);
var arity = cljs.core.nth.call(null,vec__22592,(1),null);
var vec__22595 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22595,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22595,(1),null);
var vec__22598 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22598,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22598,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22598,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22598,(3),null);
...
var vec__22604 = result;
var munged_ns = cljs.core.nth.call(null,vec__22604,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22604,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22604,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22604,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22604,(4),null);
var arity = cljs.core.nth.call(null,vec__22604,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22608 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22608,(0),null);
var args = cljs.core.nth.call(null,vec__22608,(1),null);
var vec__22611 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22611,(0),null);
var name = cljs.core.nth.call(null,vec__22611,(1),null);
...
var G__22614 = (arity + (1));
var G__22615 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22616){
var vec__22617 = p__22616;
var arity = cljs.core.nth.call(null,vec__22617,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22617,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22620_SHARP_){
return cljs.core.get.call(null,arities,p1__22620_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22621_SHARP_){
return cljs.core.drop.call(null,(2),p1__22621_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22624){
var vec__22625 = p__22624;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22625,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22622){
var G__22623 = cljs.core.first.call(null,seq22622);
var seq22622__$1 = cljs.core.next.call(null,seq22622);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22623,seq22622__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22633__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22633__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22633__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22633__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22634 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22634,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22634,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22634,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22634,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22634,(4),null);
var arity = cljs.core.nth.call(null,vec__22634,(5),null);
...
var o__21909__auto__ = f;
return (o__21909__auto__["getBasis"]).call(o__21909__auto__);
});
/**
...
}catch (e22638){var _e__21916__auto__ = e22638;
...
var G__22639 = (obj[cljs.core.first.call(null,path)]);
var G__22640 = cljs.core.rest.call(null,path);
obj = G__22639;
path = G__22640;
continue;
} else {
...
var _STAR_ = (function (accum,p__22641){
var vec__22642 = p__22641;
var bit = cljs.core.nth.call(null,vec__22642,(0),null);
var protocol = cljs.core.nth.call(null,vec__22642,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22645){
var vec__22646 = p__22645;
var ns = cljs.core.nth.call(null,vec__22646,(0),null);
var name = cljs.core.nth.call(null,vec__22646,(1),null);
var selector = cljs.core.nth.call(null,vec__22646,(2),null);
...
var post_process = (function (p__22650){
var vec__22651 = p__22650;
var munged_name = cljs.core.nth.call(null,vec__22651,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22651,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22649_SHARP_){
return (obj[cljs.core.first.call(null,p1__22649_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1688157135582
