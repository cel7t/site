...
return (new CustomEvent(event_name,(function (){var obj34063 = ({"detail":data});
return obj34063;
})()));
} else {
...
var f = (function (){var pred__34070 = cljs.core._EQ_;
var expr__34071 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34070.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34071))){
return (function (p1__34064_SHARP_){
return console.warn(p1__34064_SHARP_);
});
} else {
if(cljs.core.truth_(pred__34070.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34071))){
return (function (p1__34065_SHARP_){
return console.debug(p1__34065_SHARP_);
});
} else {
if(cljs.core.truth_(pred__34070.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34071))){
return (function (p1__34066_SHARP_){
return console.error(p1__34066_SHARP_);
});
} else {
return (function (p1__34067_SHARP_){
return console.log(p1__34067_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34074){
...
var opts = map__34075__$1;
var eval_fn = cljs.core.get.call(null,map__34075__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__34077_SHARP_){
return new_def.callback(p1__34077_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__34078){
var vec__34079 = p__34078;
var ky = cljs.core.nth.call(null,vec__34079,(0),null);
var v = cljs.core.nth.call(null,vec__34079,(1),null);
...
}catch (e34084){if((e34084 instanceof Error)){
var e = e34084;
return not_found;
} else {
throw e34084;
...
//# sourceMappingURL=utils.js.map?rel=1683240957911
